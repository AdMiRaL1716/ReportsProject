...
<body>
    <div id="app">
            ...
            <div class="scrollbar-inner">
                ...
                <div class="sidenav-header  align-items-center">
                    <a class="navbar-brand" href="javascript:void(0)">
                        <!--<h2 class="navbar-brand-img">Dashboard</h2>-->
                        ...
                        <ul class="navbar-nav">
                            <li class="nav-item">
                                <a class="nav-link active" href="{{route('home')}}">
                                    ...
                                    <span class="nav-link-text">{{ __('menu.home') }}</span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="{{route('tests')}}">
                                    <i class="ni ni-single-copy-04 text-dark"></i>
                                    <span class="nav-link-text">{{ __('menu.tests') }}</span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="{{route('reports')}}">
                                    <i class="ni ni-briefcase-24 text-orange"></i>
                                    <span class="nav-link-text">{{ __('menu.reports') }}</span>
                                </a>
                            </li>
                            @role('admin')
                                <li class="nav-item">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="{{route('customers')}}">
                                        ...
                                        <span class="nav-link-text">{{ __('menu.customers') }}</span>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="{{route('elements')}}">
                                        <i class="ni ni-atom text-green"></i>
                                        <span class="nav-link-text">{{ __('menu.elements') }}</span>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="{{route('units')}}">
                                        <i class="ni ni-book-bookmark text-purple"></i>
                                        <span class="nav-link-text">{{ __('menu.units') }}</span>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="{{route('methods')}}">
                                        <i class="ni ni-paper-diploma text-yellow"></i>
                                        <span class="nav-link-text">{{ __('menu.methods') }}</span>
                                    </a>
                                </li>
                            @endrole
                        </ul>
                        ...
                        <form action="{{ route('search') }}" method="GET" class="navbar-search navbar-search-light form-inline mr-sm-3" id="navbar-search-main">
                            ...
                            <div class="form-group mb-0">
                                <div class="input-group input-group-alternative input-group-merge">
                                    ...
                                    <input class="form-control" placeholder="{{ __('menu.search') }}" name="search" type="text">
                        ...
                        <ul class="navbar-nav align-items-center  ml-md-auto ">
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-xl dropdown-menu-right py-0 overflow-hidden">
                                    <!-- Dropdown header -->
                                    <div class="px-3 py-3">
                                        <h6 class="text-sm text-muted m-0">{{ __('menu.languages') }}</h6>
                                    </div>
                                    <!-- List group -->
                                    <div class="list-group list-group-flush">
                                        <a href="{{ route('locale', ['locale' => 'en']) }}" class="list-group-item list-group-item-action">
                                            <div class="row align-items-center">
                                                <div class="col-auto">
                                                    <!-- Avatar -->
                                                    <img alt="Image placeholder" src="{{asset('images/flags/eng.png')}}" class="avatar rounded-circle">
                                                </div>
                                                <div class="col ml--2">
                                                    ...
                                                    <p class="text-sm mb-0">Translation to English</p>
                                                </div>
                                            </div>
                                        </a>
                                        <a href="{{ route('locale', ['locale' => 'et']) }}" class="list-group-item list-group-item-action">
                                            <div class="row align-items-center">
                                                <div class="col-auto">
                                                    <!-- Avatar -->
                                                    <img alt="Image placeholder" src="{{asset('images/flags/est.png')}}" class="avatar rounded-circle">
                                                </div>
                                                <div class="col ml--2">
                                                    <div class="d-flex justify-content-between align-items-center">
                                                        <div>
                                                            <h4 class="mb-0 text-sm">Eesti</h4>
                                                        </div>
                                                    </div>
                                                    <p class="text-sm mb-0">Tõlkima eesti keelde</p>
                                                </div>
                                            </div>
                                        </a>
                                        <a href="{{ route('locale', ['locale' => 'ru']) }}" class="list-group-item list-group-item-action">
                                            <div class="row align-items-center">
                                                <div class="col-auto">
                                                    <!-- Avatar -->
                                                    <img alt="Image placeholder" src="{{asset('images/flags/rus.png')}}" class="avatar rounded-circle">
                                                </div>
                                                <div class="col ml--2">
                                                    <div class="d-flex justify-content-between align-items-center">
                                                        <div>
                                                            <h4 class="mb-0 text-sm">Русский</h4>
                                                        </div>
                                                    </div>
                                                    <p class="text-sm mb-0">Перевести на русский</p>
                                                </div>
                                            </div>
                                        </a>
                                    </div>
                        ...
                        <ul class="navbar-nav align-items-center  ml-auto ml-md-0 ">
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu  dropdown-menu-right ">
                                    ...
                                    <a href="{{route('customs')}}" class="dropdown-item">
        ...
        @else
            <div class="alert alert-warning border-radius-0 text-center" role="alert">
                <span class="alert-icon"><i class="ni ni-bell-55"></i></span>
                <span class="alert-text"><strong>Notification!</strong> To use the system - the administrator must confirm your profile!</span>
                <a href="{{ route('logout') }}" class="btn btn-secondary logout-button" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
                    <span>Logout</span>
                </a>
                <form id="logout-form" action="{{ route('logout') }}" method="POST" class="d-none">
                    @csrf
